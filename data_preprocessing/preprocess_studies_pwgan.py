...
def preprocess_dataset(data_path, speaker_id, cache_folder='./cache/'):
    ...
    # mel_normalized:
    #   melのリスト，中身は2次元のmelで[n_mels, sequence]
    mel_normalized, mel_mean, mel_std, wav_list = normalize_mel(data_path)
    ...
    save_pickle(variable=wav_list,
                fileName=os.path.join(cache_folder, speaker_id, f"{speaker_id}_filepath.pickle"))
...
if __name__ == '__main__':
    ...
    parser.add_argument('--data_directory', type=str, default='STUDIES_22K_reconst',
                        help='Directory holding STUDIES dataset.')
    parser.add_argument('--preprocessed_data_directory', type=str, default='STUDIES_22k_reconst_preped/tr_no_dev',
